...
//!
    ...
    public:
        ...
        size_t nbBytes() const {
            return this->size() * tensorrt_virgo_common::getElementSize(mType);
        }
        ...
        void resize(const nvinfer1::Dims &dims) {
            return this->resize(tensorrt_virgo_common::volume(dims));
        }
        ...
        BufferManager(std::shared_ptr<nvinfer1::ICudaEngine> engine, const int batchSize = 0,
            ...
            for (int i = 0; i < mEngine->getNbBindings(); i++) {
                ...
                if (-1 != vecDim) // i.e., 0 != lgScalarsPerVector
                {
                    ...
                    dims.d[vecDim] = tensorrt_virgo_common::divUp(dims.d[vecDim], scalarsPerVec);
                    vol *= scalarsPerVec;
                }
                vol *= tensorrt_virgo_common::volume(dims);
